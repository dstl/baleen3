...
import { PipelineViewContainer } from '../containers/PipelineViewContainer'

export type PipelineViewProps = Readonly<
  RouteComponentProps & {
    pipelineId?: string
...
export const PipelineView = ({
  ...
  return (
    <div data-testid="PipelineView">
      <PipelineViewContainer name={pipelineId} navigate={navigate} />
    </div>
  )
}
