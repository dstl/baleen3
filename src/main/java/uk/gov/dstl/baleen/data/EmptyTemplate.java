...
public final class EmptyTemplate extends PipelineTemplate {
  public EmptyTemplate() {
    ...
    this.setIcon("CheckBoxOutlineBlank");
    this.setDescription("An empty pipeline for creating pipelines from scratch.");
    this.setOrderer("io.annot8.api.pipelines.NoOpOrderer");
  }
}
